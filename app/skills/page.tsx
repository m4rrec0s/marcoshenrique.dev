        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-4">
            ...
            <div>
              ...
              <SkillProgress name="Python" percentage={75} delay={0.2} />
              <SkillProgress name="Docker" percentage={70} delay={0.3} />
              <SkillProgress name="UI/UX Design" percentage={85} delay={0.4} />
              <SkillProgress name="Git/GitHub" percentage={90} delay={0.5} />
            </div>
          </div>
        </motion.div>
      </motion.div>
          ...
          <div>
            <div className="text-center px-4 py-2">
              ...
              <p className="text-gray-300">
                Estou constantemente aprendendo e atualizando minhas habilidades
                para acompanhar as últimas tendências e tecnologias no
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300 text-sm">
              Desenvolvimento ágil, trabalho em equipe, resolução de problemas e
